...
<div className="w-full mb-14">
      <Row style={{ marginLeft: "5%" }}>
        <Col span={8}>
          <h3 className="heading3 text-4xl md:text-5xl font-bold">Photographer</h3>
          <div className="body text-xl w-full">
            <div className="titleText block mt-4 m-0 w-full font-normal">
              <span>
              Gain proficiency in using Adobe Photoshop for image editing, retouching, and mastering essential skills such as layer manipulation, color correction, and digital painting. Mastering Adobe Photoshop is essential for graphic designers, photographers, and digital artists.              </span>
            </div>
            <div className="titleText block mt-4 m-0 w-full font-normal">
              <span>
              Use different manipulation and creation tools, use Photoshop in professional projects, master Photo correction techniques         
               </span>
            </div>
          </div>
        </Col>
